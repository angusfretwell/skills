...
4. Run `/verify` on the PR, the issue's acceptance criteria as its criteria. Drive the app in a sub-agent briefed to **return** its evidence — never to message it — so the logs and screenshots stay out of your context.
