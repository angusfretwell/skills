Land slice {{SLICE_ID}} of issue {{ISSUE_ID}} onto branch {{BRANCH}}: slice branch {{SLICE_BRANCH}}, worktree {{SLICE_WORKTREE}}, recorded in {{STATE_DIR}}/notes/*-slice-{{SLICE_ID}}.md.
