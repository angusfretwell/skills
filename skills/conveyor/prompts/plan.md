...
2. **Scaffold.** Create the issue worktree and branch, push it, and open a **draft PR** whose body is a placeholder: one line pointing at the issue — the real description comes after implementation.
