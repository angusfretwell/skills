...
2. **Scaffold.** Create the issue worktree and branch, make an empty commit (a PR cannot open on a branch identical to base), push, and open a **draft PR** whose body is a placeholder: one line pointing at the issue — the real description comes after implementation.
