...
2. **Scaffold.** Create the issue worktree and branch using `/worktrunk:worktrunk`, push it, and open a **draft PR** using `/open-pr`, except the body is a placeholder: one line pointing at the issue — the real description comes after implementation.
