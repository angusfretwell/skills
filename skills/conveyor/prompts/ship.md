...
**Finalize:** mark the issue done in the tracker, remove the issue worktree and any leftover slice worktrees with `wt`, and close the issue's Herdr workspace. Outcome verdict `done`.
