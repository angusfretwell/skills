...
Round `<n>`. The scope is the diff from base; the spec is the acceptance criteria from the issue. On later rounds, also re-exercise what the previous round's failed items covered.
